...
const App = observer(() => {
    const mapToken = "pk.eyJ1IjoibmV3ZW04NjU5OSIsImEiOiJjbGwyOTFjZTkwNXFqM3FvNWt3dGt4M210In0.HO6Gh7kyE1d-UHOc6F0yOA";
    const {expandApp, initBackButton, showTelegramAlert, user, showMainButton} = useTelegram();
